...
public final class Act1D2MOOLayoutBridge {
    ...
    private static final int[] D2MOO_ACT1_LEVEL_IDS = {
        ...
        // Dynamic quest/cube portals are not encoded as static wall specials.
    ...
    public static final class Act1LayoutResult {
         ...
         * 13=Tristram, 14=Moo Moo Farm. Native linked sublevels discovered
         * from actual warp specials follow. */
