 ...
 * - params[3] = CORRUPTROGUE_AI_PARAM_RUN_VELOCITY (run velocity)
 * - params[4] = CORRUPTROGUE_AI_PARAM_RUN_CHANCE_PCT (run chance)
 */
public class CorruptRogue extends AI {
  ...
  public CorruptRogue(int entityId) {
    super(entityId);
