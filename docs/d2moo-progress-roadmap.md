...
| 职业 | 当前完成 | 剩余 | 主要缺口 |
|---|---:|---:|---|
| 亚马逊 Amazon | 88% | 12% | 弓/弩弹药权威消耗已完成；命中/受击动画反馈和少量持续效果仍待补齐 |
...
- [ ] 完成亚马逊剩余弓系运行时细节
  ...
  - 待补：自动恢复数量词缀、完整命中与受击动画反馈、少量持续火焰/冰冻效果；当前专项完成度约 88%，不能整体划掉。
...
已完成 **亚马逊弓/弩弹药权威消耗与多人余量同步**。
下一项调整为 **亚马逊自动恢复数量与元素箭持续命中表现**；完成剩余亚马逊运行时细节后，再回到刺客陷阱生命周期（SrvDo044/SrvDo045）。
