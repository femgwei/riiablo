...
| 野蛮人 Barbarian | 75% | 25% | Frenzy、Whirlwind 已完成；Berserk 防御归零与战吼仍待补齐 |
...
职业技能专项整体按 **约 68% 完成、约 32% 剩余** 计入战斗模块；刺客专项已完成，
其余职业仍按各自行所列缺口继续推进。
...
刺客专项已经完成；野蛮人 Frenzy 与 Whirlwind 的服务端权威序列、碰撞和多人快照也已接通。

下一项进入 **Berserk（狂战士）**：优先对齐物理转魔法顺序、`calc1/calc4` 协同、
防御归零状态和单次命中动画；随后处理战吼范围状态与多人表现。
