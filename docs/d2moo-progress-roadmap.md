...
| 野蛮人 Barbarian | 63% | 37% | Frenzy 已完成；Whirlwind 路径/周期攻击、Berserk 防御归零与战吼仍待补齐 |
...
职业技能专项整体按 **约 65% 完成、约 35% 剩余** 计入战斗模块；刺客专项已完成，
其余职业仍按各自行所列缺口继续推进。
...
刺客专项已经完成；野蛮人 Frenzy 的双持连续命中、速度状态和多人快照也已接通。

下一项进入 **Whirlwind（旋风斩）**：优先对齐技能起手与路径校验、移动中的周期目标扫描、
双持交替攻击、路径碰撞/结束条件和多人位移动画，再处理 Berserk 防御归零与战吼。
