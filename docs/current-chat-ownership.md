...
当前目标是 **P1 死灵法师 Raise Skeleton/Skeletal Mage 召唤链**：实现尸体一次原子
消费、PetType/PetMax、召唤所有权、死亡/断线/跨区清理与多人实体快照；随后处理
Revive/Golem、Iron Maiden/Life Tap 事件回调和诅咒复杂 AI 分支。战斗模块不再单独
分派，相关修改均由本 Chat 负责。
