...
- 分支：`master`
- 当前功能提交：`c297c6ec`（攻击动画缓存与 Automap/UI 修复后的统一基线）
- 上一功能基线：`84e052cf`（Automap 选项、城镇揭示、比例与实体标记）
...
新 Chat 应首先阅读 [`codex-handoff-2026-09-15.md`](codex-handoff-2026-09-15.md)。该文件
